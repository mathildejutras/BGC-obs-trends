...
Running this script requires downloading the BGC-Argo, GLODAP and WOD datasets.

* **utils_gridding.py**
This script contains functions used in gridded_trends_from_obs.py.

List of input files used in the scripts:

* **Maximum_seasonal_MLD.nc**
This file contains the maximum seasonal mixed layer depth over 20 years, calculated from the RG-gridded Argo product (Roemmich & Gilson, 2009). 
It serves to remove the data located within the mixed layer from the analysis.

* **Climatologies_gamma_2.5.nc**
This file contains climatologies of depth, nitrate, oxygen, DIC, pH, temperature and salinity on a 2.5 degree grid and on 0.1 kg/m³ neutral density layers.
